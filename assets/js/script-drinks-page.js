...
const resultantDrinkPanel = function (data) {
  ...
  var saveDrinkToFavorites = function (event) {
    ...
    if (!drinks.includes(randomDrink)) {
      ...
      saveToDrinkFavoriteLibrary() // save to local storage
    }
  }
...
// NEED HELP HERE ? -LD 
// var saveDrinkToFavorites = function (event) {
//   var randomDrink = document.getElementsByClassName("drink-title")
//   console.log(randomDrink.innerHTML)
//   // check if drink is already saved to local storage
//   // if drink isn't already saved, then save drink
//   if (!drinks.includes(randomDrink)) {
//     drinks.push(randomDrink) // push the drink into the drinks array
//     saveToDrinkSearchHistory() // save to local storage
//   }
// }


/////   saves random drink to local storage   /////

var saveToDrinkFavoriteLibrary = function () {
